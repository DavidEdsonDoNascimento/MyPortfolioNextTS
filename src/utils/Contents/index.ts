export abstract class Content {
  ...
  static about(): string {
    return `Meu nome é David Edson, tenho 26 anos, sou Desenvolvedor Full Stack, trabalho com amor e cuidado nos códigos,
    Este ano de 2021 estou concentrado em me especializar nas tecnologias que permeiam o JavaScript, estudando todos os dias, sempre Node, JavaScript, Typescript, ReactJS, NextJS, Angular, ou regras de negocios, buscando seguir as boas práticas, padrões de projetos, sempre procurando acordar todos os dias à procura de alguma nova coisa que possa ajudar alguém no futuro, seguindo a ideologia do 1% todos os dias, ajudando assim clientes e empresas a alcançar a excelencia.
    
    Tenho proficiencia com:
    NodeJS, Typescript, Javascript, ReactJS, NextJS, SQL, Banco de dados, SCRUM, HTML e CSS..`;
  }
